...
class Ts_Widget extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array(
			'classname'   => 'jthemes',
			'description' => __( 'Jthemes Shortcodes widget', 'jthemes' )
		);
		$control_ops = array(
			'width'   => 300,
			'height'  => 350,
		...
		parent::__construct( 'jthemes', __( 'Jthemes Shortcodes', 'jthemes' ), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		$defaults = array(
			'title'   => __( 'Jthemes Shortcodes', 'jthemes' ),
			'content' => ''
		);
		$instance = wp_parse_args( ( array ) $instance, $defaults );
?>
				<p>
					<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'jthemes' ); ?></label>
