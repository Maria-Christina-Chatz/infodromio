...
class Ts_Assets {
	...
	public static function register() {
		...
		wp_localize_script( 'magnific-popup', 'ts_magnific_popup', array(
				'close'   => __( 'Close (Esc)', 'jthemes' ),
				'loading' => __( 'Loading...', 'jthemes' ),
				'prev'    => __( 'Previous (Left arrow key)', 'jthemes' ),
				'next'    => __( 'Next (Right arrow key)', 'jthemes' ),
				'counter' => sprintf( __( '%s of %s', 'jthemes' ), '%curr%', '%total%' ),
				'error'   => sprintf( __( 'Failed to load this link. %sOpen link%s.', 'jthemes' ), '<a href="%url%" target="_blank"><u>', '</u></a>' )
			) );
		// Ace
		...
		wp_localize_script( 'ts-options-page', 'ts_options_page', array(
				'upload_title'  => __( 'Choose files', 'jthemes' ),
				'upload_insert' => __( 'Add selected files', 'jthemes' ),
				'not_clickable' => __( 'This button is not clickable', 'jthemes' )
			) );
		// Cheatsheet
		...
		wp_localize_script( 'ts-generator', 'ts_generator', array(
				'upload_title'         => __( 'Choose file', 'jthemes' ),
				'upload_insert'        => __( 'Insert', 'jthemes' ),
				'isp_media_title'      => __( 'Select images', 'jthemes' ),
				'isp_media_insert'     => __( 'Add selected images', 'jthemes' ),
				'presets_prompt_msg'   => __( 'Please enter a name for new preset', 'jthemes' ),
				'presets_prompt_value' => __( 'New preset', 'jthemes' ),
				'last_used'            => __( 'Last used settings', 'jthemes' ),
		...
		wp_localize_script( 'ts-other-shortcodes', 'ts_other_shortcodes', array( 'no_preview' => __( 'This shortcode doesn\'t work in live preview. Please insert it into editor and preview on the site.', 'jthemes' ) ) );
	...
	public static function mce_js( $plugins ) {
		$plugins['Jthemesshortcodes'] = plugins_url( 'assets/js/tinymce.js', TS_PLUGIN_FILE );
		return $plugins;
	}
	...
	public static function skin_url( $file = '' ) {
		...
		$url = ( !$skin || $skin === 'default' ) ? plugins_url( 'assets/css/', TS_PLUGIN_FILE ) : $uploads . '/Jthemes-skins/' . $skin;
